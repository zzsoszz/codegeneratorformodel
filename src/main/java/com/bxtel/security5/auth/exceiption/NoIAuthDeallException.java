 ...
 * @author Ben Alex
 */
public class NoIAuthDeallException extends AuthenticationException {
    //~ Constructors ===================================================================================================
     ...
     */
    public NoIAuthDeallException(String msg) {
        super(msg);
    }
     ...
     * @param t root cause
     */
    public NoIAuthDeallException(String msg, Throwable t) {
        super(msg, t);
    }
}